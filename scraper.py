...
class CancerSpider(scrapy.Spider):
    ...
    name = "cancer_spider"
    start_urls = [
        'https://www.cancerresearchuk.org/about-cancer/cancer-chat/thread/radiotherapy-for-throat-cancer']
    try:
        os.makedirs('scrapes')
    except OSError as e:
